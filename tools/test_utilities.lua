...
WQA.IsCallingActive = function(_, questID) return questID == 101 end
WQA.GetCallingTimeLeftMinutes = function(_, questID) return questID == 101 and 42 or 0 end
assert(WQA:GetTaskZoneID(worldQuest) == 80)
assert(WQA:GetTaskZoneID(calling) == 1699)
